<x-app-layout>
    ...
    <main>
        <div class="container py-6">
            ...
            <div class="mb-5">
                <h2 class="mb-4 text-2xl">Here you can see our last Total stats</h2>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                    ...
                    <div
                        ...
                        <div class="flex flex-row gap-2">
                            <div class="text-xl font-bold text-gray-400">ROI:</div>
                            <div class="text-xl font-bold @if($data30[$sub['name']]['roi'] > 50) {{"text-primary"}} @endif">{{$data30[$sub['name']]['roi']}}%</div>
                        </div>
                    </div>
                    <hr class="shrink-0 bg-divider border-none w-full h-divider" role="separator">
                    <div
                        class="relative w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased grid grid-cols-3 gap-3 lg:grid-cols-5">
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data30[$sub['name']]['total']}}</div>
                            <div class="uppercase text-gray-300">Total</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data30[$sub['name']]['won']}}</div>
                            <div class="uppercase text-gray-300">Won</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data30[$sub['name']]['lost']}}</div>
                            <div class="uppercase text-gray-300">Lost</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data30[$sub['name']]['stake']}}</div>
                            <div class="uppercase text-gray-300">Stake</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data30[$sub['name']]['profit']}}</div>
                            <div class="uppercase text-gray-300">Profit</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-5">
                <h2 class="mb-4 text-2xl">Here you can see our last 7 days stats</h2>
            </div>
            <div>
                @foreach ($subscriptions as $sub)
                <div class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                    ...
                    <div
                        ...
                        <div class="flex flex-row gap-2">
                            <div class="text-xl font-bold text-gray-400">ROI:</div>
                            <div class="text-xl font-bold @if($data7[$sub['name']]['roi'] > 50) {{"text-primary"}} @endif">{{$data7[$sub['name']]['roi']}}%</div>
                        </div>
                    </div>
                    <hr class="shrink-0 bg-divider border-none w-full h-divider" role="separator">
                    <div
                        class="relative w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased grid grid-cols-3 gap-3 lg:grid-cols-5">
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data7[$sub['name']]['total']}}</div>
                            <div class="uppercase text-gray-300">Total</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data7[$sub['name']]['won']}}</div>
                            <div class="uppercase text-gray-300">Won</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data7[$sub['name']]['lost']}}</div>
                            <div class="uppercase text-gray-300">Lost</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data7[$sub['name']]['stake']}}</div>
                            <div class="uppercase text-gray-300">Stake</div>
                        </div>
                        <div class="flex flex-col items-center gap-1">
                            <div class="text-xl font-bold">{{$data7[$sub['name']]['profit']}}</div>
                            <div class="uppercase text-gray-300">Profit</div>
                        </div>
                    </div>
                </div>
