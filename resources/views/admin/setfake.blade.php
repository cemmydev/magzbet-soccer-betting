...
<script>
    ...
    function createExtraGameElement() {
        ...
        newDateInput.setAttribute('required', 'true');
        ...
        newteam1Input.setAttribute('required', 'true');
        ...
        addOptionButton.addEventListener('click', function() {
            ...
            newOptionTitle.setAttribute('required', 'true');
            ...
            newOptionContent.setAttribute('required', 'true');
