<form method="post" class="p-4" >
    ...
    <input id="sub_name" type="text" class="block w-full p-2 dark:bg-darker" name="name">
    <label for="sub_cost">Subscription Cost</label>
    <input id="sub_cost" type="text" class="block w-full p-2 dark:bg-darker" name="cost">
    <label for="sub_description">Description</label>
    <input id="sub_description" type="text" class="block w-full p-2 dark:bg-darker" name="description">
