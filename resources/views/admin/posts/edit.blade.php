<form method="post" class="p-4">
    ...
    <input id="bet_create_event" type="text" class="block w-full p-2" name="event" value="{{$post['event']}}">
    <label for="bet_create_date">date</label>
    <input id="bet_create_date" type="date" class="block w-full p-2" name="date" value="{{$post['date']}}">
    <label for="bet_create_description">description</label>
    <input id="bet_create_description" type="text" class="block w-full p-2" name="description" value="{{$post['description']}}">
    ...
    <input id="bet_create_odd" type="text" class="block w-full p-2" name="odds" value="{{$post['odds']}}">
    <label for="bet_create_stake">stake</label>
    <input id="bet_create_stake" type="text" class="block w-full p-2" name="stake" value="{{$post['stake']}}">
    <label for="bet_create_gain">gain</label>
    <input id="bet_create_gain" type="text" class="block w-full p-2" name="gain" value="{{$post['gain']}}">
    <label for="bet_create_profit">profit</label>
    <input id="bet_create_profit" type="text" class="block w-full p-2" name="profit" value="{{$post['profit']}}">
