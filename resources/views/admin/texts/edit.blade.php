...
<div class="min-w-screen bg-gray-200 px-5 py-5 dark:bg-darker">
    <form action="" method='post'>
        ...
        <input id="ud_text_edit_field" type="text" class="block w-full p-2 dark:bg-darker mb-3" readonly name="field" value="{{$text['field']}}">
        <input type="hidden" name="text" id="ud_text_text" value="{{$text['text']}}">
    </form>
...
<script>
    function app() {
        var text = {!!json_encode($text['text'])!!};
        return {
            wysiwyg: null,
            init: function(el) {
                // Get el
                ...
                *, ::after, ::before {box-sizing: border-box;}
                ...
                this.wysiwyg.contentDocument.body.innerHTML += text;
                // Make editable
