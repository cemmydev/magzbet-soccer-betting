<div class="min-w-screen bg-gray-200 px-5 py-5 dark:bg-darker">
    ...
    <form action="" method='post'>
        ...
        <input type="text" class="block w-full p-2 dark:bg-darker mb-3" name="field" value="{{$text['field']}}">
        <label for="ud_text_text">Content</label>
        <textarea name="text" id="ud_text_text" rows="10" class="block w-full p-2 dark:bg-darker mb-3" placeholder="Type here within HTML format...">{{$text['text']}}</textarea>
