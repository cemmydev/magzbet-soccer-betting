            ...
            <div class="lg:basis-1/4">
                <div class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-none rounded-large transition-transform-background motion-reduce:transition-none"
                    ...
                    <div
                        ...
                        <div class="mb-5 flex flex-col items-center"><span tabindex="-1"
                                class="flex relative justify-center items-center box-border overflow-hidden align-middle z-0 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-tiny bg-primary text-primary-foreground rounded-full ring-2 ring-offset-2 ring-offset-background dark:ring-offset-background-dark ring-primary h-24 w-24"><img
                                    src="/images/logo.webp"
                                    class="flex object-cover w-full h-full transition-opacity !duration-500 opacity-0 data-[loaded=true]:opacity-100"
                                    alt="avatar" data-loaded="true"></span></div>
                        <div class="flex flex-row justify-center gap-4"><input accept="image/*" class="hidden"
                                type="file"><button
                                ...
                                data-disabled="true" type="button" disabled=""><svg xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                                    class="iconify iconify--icon-park-outline" width="1em" height="1em"
                                    viewBox="0 0 48 48">
                    ...
                    <div
                        ...
                        <h5 class="text-xl font-bold">@rouf7</h5>
                        <p class="text-sm text-gray-300">makis.kammakis@gmail.com</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <div data-slot="input-wrapper"
                                        ...
                                        <div data-slot="inner-wrapper"
                                            ...
                                            <input data-slot="input"
                                                ...
                                                type="text" value="makis.kammakis@gmail.com" data-filled="true"
                                    ...
                                    <div data-slot="input-wrapper"
                                        ...
                                        <div data-slot="inner-wrapper"
                                            ...
                                            <input data-slot="input"
                                                ...
                                                type="text" value="rouf7" data-filled="true" data-filled-within="true">
                                        </div>
                                    </div>
                                </div><button
