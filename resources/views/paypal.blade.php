        ...
        <div class="col-10 offset-1 mt-5">
            <div class="flex flex-col w-full sm:max-w-md mt-6 p-6 shadow-md overflow-hidden sm:rounded-lg bg-default/40 text-default-foreground text-center">
                ...
                <div class="card-body">
                    ...
                    <center>
                        <a href="{{ route('paypal.payment') }}" class="z-0 group relative inline-flex items-center justify-center box-border appearance-none select-none whitespace-nowrap font-normal subpixel-antialiased overflow-hidden tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 px-unit-4 min-w-unit-20 h-unit-10 text-small gap-unit-2 rounded-medium [&>svg]:max-w-[theme(spacing.unit-8)] data-[pressed=true]:scale-[0.97] transition-transform-colors-opacity motion-reduce:transition-none bg-primary text-primary-foreground data-[hover=true]:opacity-hover">Pay with PayPal </a>
                    </center>
