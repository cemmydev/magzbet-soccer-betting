<html lang="en" dir="ltr" class="dark" style=""><merlin-component id="merlin-text-summarizer"
  class="merlin text-summarizer"></merlin-component><merlin-component id="merlin-tutorial"
  class="merlin-tutorial"></merlin-component><merlin-component id="merlin-preview-link"
  class="merlin merlin-preview-link"></merlin-component><merlin-component id="merlin-context-btn"
  class="merlin context-btn"></merlin-component><merlin-component id="merlin-chat"
  class="merlin chat"></merlin-component>
...
<head>
  ...
  <link rel="preload" as="image" href="http://bettok.gr/images/logo.webp">
  <link rel="preload" as="image" href="http://bettok.gr/images/eeep_footer.svg">
  <link rel="preload" as="image" href="http://bettok.gr/images/cookie.png">
  <link rel="preload" href="https://www.googletagmanager.com/gtag/js?id=G-P7KHP630MJ" as="script">
  ...
  <link rel="stylesheet"
    href="data:text/css,@import%20url%28%27https%3A//support.bettok.gr/assets/chat/chat.css%27%29%3B">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta charset="utf-8">
  <title>BetTok</title>
  <meta name="application-name" content="BetTok">
  <meta property="og:title" content="BetTok">
  <meta property="og:url" content="https://bettok.gr/">
  <meta property="og:site_name" content="BetTok">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="BetTok">
  <link rel="icon" href="/favicon.ico" type="image/x-icon" sizes="16x16">
</head>

<body monica-version="4.7.6" monica-id="ofpnmcalabcbjgholdjcjblkibolbppb">
      ...
      <header
        ...
        <ul
          ...
          <div
            ...
            <img src="http://bettok.gr/images/logo.webp" alt="Logo" class="h-10"></div>
        </ul>
        <ul
          ...
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              ...
              tabindex="0" role="link" href="/" previewlistener="true" style="user-select: none;">Home</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              ...
              tabindex="0" role="link" href="/bets" previewlistener="true">Bets</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/bots" previewlistener="true">Bots</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/bets/results" previewlistener="true"
              style="user-select: none;">Results</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/stats" previewlistener="true" style="user-select: none;">Stats</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/chat" previewlistener="true" style="user-select: none;">Chat</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/livescore" previewlistener="true" style="user-select: none;">Live
              Score</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-foreground no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
              tabindex="0" role="link" href="/contact" previewlistener="true" style="user-select: none;">Contact</a>
          </li>
        </ul>
        <ul
          ...
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><a
              ...
              role="button" tabindex="0" href="/auth/signup" previewlistener="true">Sign Up</a></li>
          <li class="text-medium whitespace-nowrap box-border list-none data-[active=true]:font-semibold"><button
    ...
    <main><!--$--><!--/$-->
      <div class="isolate bg-gray-900">
        <div class="relative flex min-h-[400px] flex-col justify-center gap-6 overflow-hidden p-16 sm:min-h-[500px]">
          <img src="http://bettok.gr/images/hero.webp" alt="Hero"
            class="absolute inset-0 -z-10 h-full w-full object-cover brightness-[0.5]"><img class="mx-auto h-32 sm:h-48"
            src="http://bettok.gr/images/logo.webp" alt="Logo">
          <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-3">
            <div class="text-center lg:text-end"><a
                class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
                tabindex="0" role="link" target="_blank"
                href="https://play.google.com/store/apps/details?id=gr.bettok.bettok" previewlistener="true"><img
                  src="http://bettok.gr/images/appstore/google-play.png" alt="GooglePlay" class="h-12 lg:h-16"></a></div>
            <div class="text-center lg:text-start"><a
                class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
                tabindex="0" role="link" target="_blank" href="https://apps.apple.com/gr/app/bettok/id6470156990"
                previewlistener="true"><img src="http://bettok.gr/images/appstore/appstore.png" alt="AppStore" class="h-12 lg:h-16"></a>
            </div>
          </div>
          <div class="flex justify-center gap-4"><a target="_blank" class="hover:opacity-90"
              href="https://instagram.com/bettok__" previewlistener="true"><img src="http://bettok.gr/images/social/instagram.png"
                alt="instagram" class="h-12 shadow-xl"></a><a target="_blank" class="hover:opacity-90"
              href="https://t.me/+UFiXHtDTggAyZDM0" previewlistener="true"><img src="http://bettok.gr/images/social/telegram.png"
                alt="telegram" class="h-12 shadow-xl"></a></div>
        </div>
      </div>
      ...
      <section class="container py-10">
        ...
        <div class="mx-auto max-w-4xl">
          <div class="mb-4">
            <div
              class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
              tabindex="-1"><a
                ...
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1632" previewlistener="true">
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1631" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1630" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1629" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1628" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1627" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1626" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1625" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1624" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="mb-4">
            <div
              ...
              tabindex="-1"><a
                class="tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-slate-950/75"
                tabindex="0" role="link" href="/auth/login?returnUrl=%2Fbets%2F1623" previewlistener="true">
                <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    aria-hidden="true" role="img" font-size="40" class="iconify iconify--tabler" width="1em"
                    height="1em" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
    ...
    <footer>
      <div class="container flex flex-col gap-6 py-8">
        ...
        <div class="flex justify-center gap-4"><a target="_blank" class="hover:text-primary"
            ...
            previewlistener="true"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              aria-hidden="true" role="img" font-size="24" class="iconify iconify--mdi" width="1em" height="1em"
              viewBox="0 0 24 24">
              <path
        ...
        <div class="text-center"><a
            ...
            previewlistener="true"><img class="h-[60px]" alt="gamingcommission" src="http://bettok.gr/images/eeep_footer.svg"></a></div>
      </div>
    </footer>
    <div style="position:fixed;z-index:9999;top:16px;left:16px;right:16px;bottom:16px;pointer-events:none"></div><button
      class="toggle-consent" type="button" data-cc="c-settings" aria-haspopup="dialog"><img src="http://bettok.gr/images/cookie.png"
        alt="cookie-icon"></button>
  </div>
  <script id="google-ga4" type="text/javascript" data-nscript="afterInteractive">
    window.dataLayer = window.dataLayer || [];
    function gtag() { window.dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'G-P7KHP630MJ');
  </script>
  <script src="https://code.jquery.com/jquery-3.6.0.min.js" id="jQuery" data-nscript="afterInteractive"></script>
  <div id="cc--main" class="c--anim" style="position: fixed;">
    <div id="cc_div" class="cc_div">
      <div tabindex="-1" id="s-cnt" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="s-ttl"
        class="slide" style="visibility: hidden;">
        <div id="c-vln">
          <div id="cs">
            <div id="c-s-in">
              <div id="s-inr" class="bns-t">
                <div id="s-hdr">
                  <h2 id="s-ttl">Cookie Preferences</h2>
                  <div id="s-c-bnc"><button type="button" id="s-c-bn" class="c-bn" aria-label="Close"><span
                        tabindex="-1"></span></button></div>
                </div>
                <div id="s-bl">
                  <div class="c-bl">
                    <div class="title">
                    ...
                    <div class="desc">
                      <div class="p">We use cookies to ensure the basic functionality of the website and to improve your
                        online experience. You can choose to opt-in/out for each category whenever you want.</div>
                    </div>
                  </div>
                  <div class="c-bl b-ex">
                    <div class="title b-bn"><button type="button" class="b-tl exp" aria-expanded="false"
                        aria-controls="c-ac-1">Strictly necessary cookies</button><label class="b-tg"><input
                          class="c-tgl" type="checkbox" value="necessary" disabled=""><span class="c-tg c-ro"
                          aria-hidden="true"><span class="on-i"></span><span class="off-i"></span></span><span
                          class="t-lb">Strictly necessary cookies</span></label></div>
                    <div class="desc b-acc" id="c-ac-1" aria-hidden="true">
                      <div class="p">These cookies are necessary for the proper functioning of my website. Without these
                        cookies, the website would not function properly.</div>
                    </div>
                  </div>
                  <div class="c-bl b-ex">
                    <div class="title b-bn"><button type="button" class="b-tl exp" aria-expanded="false"
                        aria-controls="c-ac-2">Google Analytics cookies</button><label class="b-tg"><input class="c-tgl"
                          type="checkbox" value="analytics"><span class="c-tg" aria-hidden="true"><span
                            class="on-i"></span><span class="off-i"></span></span><span class="t-lb">Google Analytics
                          cookies</span></label></div>
                    <div class="desc b-acc" id="c-ac-2" aria-hidden="true">
                      <div class="p">These cookies collect information about how you use the website, which pages you
                        visited and which links you clicked on. All data is anonymous and cannot be used to identify
                        you.</div>
                    </div>
                  </div>
                  <div class="c-bl">
                    <div class="title">
                      <div class="b-tl" role="heading" aria-level="3">More information</div>
                    </div>
                    <div class="desc">
                      <div class="p">For any questions about my cookie policy and your choices, please contact us.</div>
                    </div>
                  </div>
                </div>
                <div id="s-bns"><button type="button" id="s-all-bn" class="c-bn">Accept all</button><button
                    type="button" id="s-rall-bn" class="c-bn">Reject all</button><button type="button" id="s-sv-bn"
                    class="c-bn">Save settings</button></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="https://support.bettok.gr/assets/chat/chat.min.js" async=""></script><next-route-announcer
    style="position: absolute;"></next-route-announcer><span data-focus-scope-start="true" hidden=""></span><span
    data-focus-scope-end="true" hidden=""></span>
</body>
