			...
			<div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-3">
				<div class="text-center lg:text-end">
					<a class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
						...
						href="https://play.google.com/store/apps/details?id=gr.bettok.bettok"
						previewlistener="true">
						<img src="{{ asset('assets/images/appstore/google-play.png') }}" alt="GooglePlay" class="h-12 lg:h-16">
					</a>
				</div>
				<div class="text-center lg:text-start">
					<a class="relative inline-flex items-center tap-highlight-transparent outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 text-medium text-primary no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
						...
						<img src="{{ asset('assets/images/appstore/appstore.png') }}" alt="AppStore" class="h-12 lg:h-16">
					</a>
				</div>
			</div>
			<div class="flex justify-center gap-4">
				<a target="_blank" class="hover:opacity-90" href="https://instagram.com/bettok__" previewlistener="true">
					<img src="{{ asset('assets/images/social/instagram.png') }}" alt="instagram" class="h-12 shadow-xl">
				</a>
				<a target="_blank" class="hover:opacity-90"
					href="https://t.me/+UFiXHtDTggAyZDM0" previewlistener="true">
			...
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						...
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/32e14e88-63d6-401f-97f3-4133a6a46bb2/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/a902b662-4f8b-4ac3-ba13-8fd98086c99d/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/eb83be39-ab4a-4385-9337-824c764d6d02/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/5bfb228c-cf5f-479a-b18f-84ca9d68af6a/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/3ae707ea-4a1b-4e65-b448-1e64a63e031a/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/16ac18ad-a2e0-4058-b618-c87d24a392b5/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/4b9c1939-0062-4096-bb9b-e8b9e3f49263/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/5d6405f1-9975-48e4-b608-044a4d9a1f36/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/ca985390-fb22-4d49-b5c0-8c8ca015edd8/render"></div>
				</div>
			</div>
			<div class="mb-4">
				<div class="flex flex-col overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none relative"
					...
					<div
						class="h-auto w-full items-center overflow-hidden color-inherit subpixel-antialiased rounded-b-large flex justify-center p-6">
						<img loading="lazy" alt="bet-receipt" class="h-auto max-w-full"
							src="https://api.bettok.gr/v1/attachments/edcb5dd6-03af-44d6-90aa-3ec5e290e4aa/render"></div>
				</div>
			</div>
		</div>
	</section>
