<x-app-layout>
    <div class="container py-6" style="">
        <div class="mb-4">
            <div class="mt-2 md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    <h2 class="text-2xl font-bold leading-7 text-white sm:truncate sm:text-3xl sm:tracking-tight">Results
                    </h2>
                </div>
            </div>
        </div>
        <div class="mb-6"><a
                ...
                tabindex="-1" href="/bets/1230" previewlistener="true">
                <div
                    ...
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>10-02-2024 07:15</div>
                            </div>
                            <div class="text-xl font-bold">ESGUEIRA VS SPORTING</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">1.9</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">190</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div
                                    ...
                                    <span class="flex-1 text-inherit font-normal px-2">WON</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1227" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>03-02-2024 08:00</div>
                            </div>
                            <div class="text-xl font-bold">SHUMEN VS CSKA</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">185</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1218" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>02-02-2024 07:30</div>
                            </div>
                            <div class="text-xl font-bold">KALEV VS RAPLA</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">1.57</div>
                                <div class="text-sm font-bold text-gray-400">Odds</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">100</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">157</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">57</div>
                                <div class="text-sm font-bold text-gray-400">Profit</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1209" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>02-02-2024 07:00</div>
                            </div>
                            <div class="text-xl font-bold">HAPOEL YAFIA</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-danger">-100</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-danger">-100</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div
                                    ...
                                    <span class="flex-1 text-inherit font-normal px-2">LOST</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1204" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            ...
                            <div class="text-xl font-bold">HOBRO VS SKIVE</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1189" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>01-02-2024 15:00</div>
                            </div>
                            <div class="text-xl font-bold">VOJVODINA VS SENCUR</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1203" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>31-01-2024 19:20</div>
                            </div>
                            <div class="text-xl font-bold">san juan</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">475</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">225</div>
                                <div class="text-sm font-bold text-gray-400">Profit</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1178" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>31-01-2024 10:00</div>
                            </div>
                            <div class="text-xl font-bold">USAC-MATONENSE</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">1.62</div>
                                <div class="text-sm font-bold text-gray-400">Odds</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">100</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">162</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">62</div>
                                <div class="text-sm font-bold text-gray-400">Profit</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1172" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>31-01-2024 07:30</div>
                            </div>
                            <div class="text-xl font-bold">balkan vs gottingen</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">1.78</div>
                                <div class="text-sm font-bold text-gray-400">Odds</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">100</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">178</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                ...
                class="flex flex-col relative overflow-hidden height-auto text-foreground box-border bg-content1 outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 shadow-medium rounded-large transition-transform-background motion-reduce:transition-none mb-4"
                tabindex="-1" href="/bets/1136" previewlistener="true">
                <div
                    class="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
                        <div class="flex flex-col justify-center gap-1 lg:basis-1/2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    ...
                                    </svg>31-01-2024 06:30</div>
                            </div>
                            <div class="text-xl font-bold">surkhon vs novi pazar</div>
                            <div class="text-md flex flex-row items-center gap-1 text-sm text-gray-400"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="iconify iconify--mdi" width="1em" height="1em"
                                    viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-row items-center gap-5 lg:basis-1/2">
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">1.7</div>
                                <div class="text-sm font-bold text-gray-400">Odds</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold">100</div>
                            ...
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">170</div>
                                <div class="text-sm font-bold text-gray-400">Gain</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div class="text-2xl font-bold text-success">70</div>
                                <div class="text-sm font-bold text-gray-400">Profit</div>
                            </div>
                            <div class="basis-1/5 text-center">
                                <div
        ...
        <div class="flex justify-center">
            <nav role="navigation" aria-label="pagination navigation" data-slot="base" data-controls="true"
                ...
                <ul data-slot="wrapper"
                    ...
                    <li role="button" tabindex="0" aria-label="pagination item 105" data-slot="item"
                        class="tap-highlight-transparent select-none touch-none first-of-type:rounded-r-none last-of-type:rounded-l-none [&amp;:not(:first-of-type):not(:last-of-type)]:rounded-none data-[pressed=true]:scale-[0.97] transition-transform-background flex flex-wrap truncate box-border items-center justify-center text-default-foreground outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 data-[disabled=true]:text-default-300 data-[disabled=true]:pointer-events-none shadow-sm bg-default-100 [&amp;[data-hover=true]:not([data-active=true])]:bg-default-200 active:bg-default-300 min-w-9 w-9 h-9 text-small rounded-medium">
                        105</li>
